...
# Calibration Plots
calib_data0_gams <- data.frame(x = predicted_probs_gams_pos[,1], y = ifelse(test_data_PL$Full_time_result_point == 0, 1, 0))
...
calib_data1_gams <- data.frame(x = predicted_probs_gams_pos[,2], y = ifelse(test_data_PL$Full_time_result_point == 1, 1, 0))
...
calib_data3_gams <- data.frame(x = predicted_probs_gams_pos[,3], y = ifelse(test_data_PL$Full_time_result_point == 3, 1, 0))
...
calib_data0_rf <- data.frame(x = rand_forest_predictions_base[,1], y = ifelse(test_data_PL$Full_time_result_point == 0, 1, 0))
...
calib_data1_rf <- data.frame(x = rand_forest_predictions_base[,2], y = ifelse(test_data_PL$Full_time_result_point == 1, 1, 0))
...
calib_data3_rf <- data.frame(x = rand_forest_predictions_base[,3], y = ifelse(test_data_PL$Full_time_result_point == 3, 1, 0))
